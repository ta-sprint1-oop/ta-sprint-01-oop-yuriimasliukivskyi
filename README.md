...
### Огляд проекту
Цей проект реалізує багатоканальну систему сповіщень (Email, SMS, Push) на мові Java. Він демонструє ключові принципи об'єктно-орієнтованого програмування (ООП), такі як успадкування, поліморфізм, інкапсуляція та шаблон проектування "Шаблонний метод" (Template Method).
